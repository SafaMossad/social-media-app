              ...
              body: ConditionalBuilder(
                ...
                fallback: (context) => Column(
                  ...
                  children: [
                    Spacer(flex:2,),
                    Center(
                      child: Text("There is no message.",style: TextStyle(color: Colors.grey[500],fontSize: 24.0)),
                    ),
                    Center(
                      child: Text("Start Sending Now...",style: TextStyle(color: Colors.grey[500],fontSize: 20.0),),
                    ),
                    Spacer(
                      flex: 2,
                    ),
